                            ...
                            <div class="sunburst_total_div">
                                <div class="sunburst_part_left">
                                    ...
                                    <div class='sunburst_sub_div' id="list_key6" style="display:block">
                                        ...
                                        <div class='sunburst_title'>Sequencing Saturation</div>
                                ...
                                <div class='sunburst_part_right'>
                                    <div class='sun_div'>
                                        ...
                                        var sun_data = [{{
                                            ...
                                            branchvalues: 'total',
                                            marker: {{'line':{{'width':10}},'colors':['#FF614F','#FFBD84','#FFCEA2','#FFE6D1','#A2D287','#C6F3AE','#FFFFFF','#FFFFFF','#98C1DD','#C2E2F9','#D7EDFB','#949ECE','#B1B8D7']}},
                                        }}];
                                        var sun_layout = {{
                                    ...
                                    <div id='divCluster', style="width:500px;margin-left:50px;margin-right:auto;margin-top:10px;float:left;">
                                        <div id="slider_square_cluster">
                                            <div id='slider_cluster'>
                                                <button id='button_cluster_ssdna' class="btn btn-link" onclick="cluster_ssdna();">show image</button>
                                                <i class="far fa-sun"></i>
                            ...
                            <div class="sub_title">
                                ...
                                <div class="content_canvas_div">
                                    <div id='divCellCluster', style="width:500px;margin-left:50px;margin-right:auto;margin-top:10px;float:left;">
                                        <div id='slider_cluster'>
                                            <button id='button_cell_cluster_ssdna' class="btn btn-link" onclick="cluster_cell_ssdna();">show image</button>
                                            <i class="far fa-sun"></i>
